...
namespace UnityEngine.UI.TableUI
{
    ...
    public class TextProperties_Editor : Editor
    {
        ...
        private void Font()
        {
            ...
            v1 = EditorToggle(rect, (tp.FontStyle & 1) == 1, k_BoldLabel, TMP_UIStyleManager.alignmentButtonLeft) ? 1 : 0; // Bold
            rect.x += rect.width;
            v2 = EditorToggle(rect, (tp.FontStyle & 2) == 2, k_ItalicLabel, TMP_UIStyleManager.alignmentButtonMid) ? 2 : 0; // Italics
            rect.x += rect.width;
            v3 = EditorToggle(rect, (tp.FontStyle & 4) == 4, k_UnderlineLabel, TMP_UIStyleManager.alignmentButtonMid) ? 4 : 0; // Underline
            rect.x += rect.width;
            v7 = EditorToggle(rect, (tp.FontStyle & 64) == 64, k_StrikethroughLabel, TMP_UIStyleManager.alignmentButtonRight) ? 64 : 0; // Strikethrough
            rect.x += rect.width;
            ...
            EditorGUI.BeginChangeCheck();
            v4 = EditorToggle(rect, (tp.FontStyle & 8) == 8, k_LowercaseLabel, TMP_UIStyleManager.alignmentButtonLeft) ? 8 : 0; // Lowercase
            ...
            rect.x += rect.width;
            EditorGUI.BeginChangeCheck();
            v5 = EditorToggle(rect, (tp.FontStyle & 16) == 16, k_UppercaseLabel, TMP_UIStyleManager.alignmentButtonMid) ? 16 : 0; // Uppercase
            ...
            rect.x += rect.width;
            EditorGUI.BeginChangeCheck();
            v6 = EditorToggle(rect, (tp.FontStyle & 32) == 32, k_SmallcapsLabel, TMP_UIStyleManager.alignmentButtonRight) ? 32 : 0; // Smallcaps
        ...
        protected GUIContent[] GetMaterialPresets()
        {
            ...
            m_MaterialPresets = FindMaterialReferences(fontAsset);
